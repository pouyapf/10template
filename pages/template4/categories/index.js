...
import ItemsCard from '@/Components/Template4/ItemsCard/ItemsCard'
import gsap from 'gsap'
import Rating from "react-rating";
import ReactModal from 'react-modal'
import Carousel from '@/Components/Template4/Carousel/Carousel'
import CommentCard from '@/Components/Template4/CommentCard/CommentCard'
...
<div className=' p-6 lg:py-15 py-6 pb-0 lg:backdrop-blur-[2px] backdrop-blur-[6px] flex flex-col justify-start items-center gap-6 w-full min-h-screen'>
...
<div className='  border-[1px] border-white/30 w-full  py-6 px-10 border-solid   rounded-[40px]  bg-white/50'>
...
<div className=' flex flex-col justify-start gap-2 items-start'>
    ...
    <span className=' hidden lg:flex text-[16px] text-[#464646] font-normal'>cosmetics & skin/haircare</span>
    <button  className=' bg-btn4  text-white text-[14px] font-extrabold px-8 py-2 rounded-[12px]'>درباره ی فروشگاه</button>
</div>
...
<div className={` ${scrolled ? '  invisible opacity-0':' max-w-full w-full rounded-[32px] '} flex    transition-all 
duration-150 ease-in-out    sticky   top-0 z-30 justify-between items-center gap-2  px-2 lg:px-6  bg-transparent  h-[100px]    lg:h-[95px] `}>

<ul className=' w-full  lg:max-w-full    h-[100px]   overflow-scroll   flex justify-start scrollbar-none gap-8 items-center  '>

     <li className=' z-50 relative   overflow-visible  w-fit  flex cursor-pointer transition-all
      duration-150 ease-in-out hover:scale-95 flex-col-reverse justify-center text-center items-center gap-2    whitespace-nowrap'> 
      
      
      <span className=' text-[#781BE1] w-fit text-[16px] font-extrabold'>لوازم آرایشی</span> 

     <div className=' flex  absolute   -bottom-6 z-50 h-1 w-[46px] bg-[#781BE1]'></div>
      </li>
      ...
      <span className=' text-[#781BE1] w-fit text-[16px] font-extrabold'>عطر و ادکلن</span> 
      ...
      <span className=' text-[#781BE1] w-fit text-[16px] font-extrabold'>محصولات مراقبت پوستی</span> 
      ...
      <span className=' text-[#781BE1] w-fit text-[16px] font-extrabold'>محصولات مراقبت مو</span> 
      ...
      <span className=' text-[#781BE1] w-fit text-[16px] font-extrabold'>لوازم بهداشتی</span> 
      ...
      <span className=' text-[#781BE1] w-fit text-[16px] font-extrabold'>محصولات آرایشی حرفه‌ای</span> 
    ...
    <button className='flex cursor-pointer text-center   justify-center items-center gap-1 px-6  min-w-[112px] lg:min-w-[182px]   bg-btn4   rounded-[10px] p-2'>
...
<span className=' lg:text-[16px] text-[12px] font-bold lg:font-extrabold  '>دسته بندیها</span>
    ...
    <div className=' flex absolute bottom-4 lg:bottom-3 w-[100%] left-1/2 -translate-x-1/2 h-[1px] bg-white'></div>
...
{scrolled ? (<div className={` ${scrolled ? ' w-[99vw]  rounded-none':'    w-0 h-0 rounded-[32px] '} flex bg-white/80   transition-all 
duration-150 ease-in-out    sticky   top-0 z-30 justify-between items-center gap-2  px-2 lg:px-6   h-[100px]    lg:h-[95px] `}>
...
<ul className=' w-full  lg:max-w-full    h-[100px]   overflow-scroll   flex justify-start scrollbar-none gap-8 items-center  '>
    ...
    <button className={`flex cursor-pointer text-center     ${scrolled ? ' opacity-100':'  opacity-0'}  justify-center items-center gap-1 px-6  min-w-[112px] lg:min-w-[182px]   bg-btn4   rounded-[10px] p-2`}>
<div className=' hidden lg:flex'>
<svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M21.5 11.4V4.6C21.5 3.1 20.86 2.5 19.27 2.5H15.23C13.64 2.5 13 3.1 13 4.6V11.4C13 12.9 13.64 13.5 15.23 13.5H19.27C20.86 13.5 21.5 12.9 21.5 11.4Z" fill="white"/>
<path d="M11 13.6V20.4C11 21.9 10.36 22.5 8.77 22.5H4.73C3.14 22.5 2.5 21.9 2.5 20.4V13.6C2.5 12.1 3.14 11.5 4.73 11.5H8.77C10.36 11.5 11 12.1 11 13.6Z" fill="white"/>
...
<div className=' relative  w-[98vw] lg:w-full flex flex-col mt-5  justify-start items-center gap-8'>
    ...
    <span className='lg:text-[20px] bg-white p-2 px-6 text-[#393939] rounded-[61px] text-[16px] font-extrabold'>عنوان دسته بندی</span>
...
<path d="M24.7163 25.9665C24.3996 25.9665 24.0829 25.8499 23.8329 25.5999L14.3996 16.1665C13.9163 15.6832 13.9163 14.8832 14.3996 14.3999C14.8829 13.9165 15.6829 13.9165 16.1663 14.3999L25.5996 23.8332C26.0829 24.3165 26.0829 25.1165 25.5996 25.5999C25.3496 25.8499 25.0329 25.9665 24.7163 25.9665Z" fill="#8F9DAF"/>
    ...
    <div className=' lg:flex hidden  right-15 top-1/2 -translate-y-1/2 absolute rounded-full
      justify-center items-center text-center  w-[336px] h-[336px] 
     lg:w-[246px] lg:h-[246px] border-[#ECE1DE] bg-[#FBD2E3] border-[1px]'>
...
<div className='w-[51px] h-[4px]  mb-2 bg-[#F3BBD2] rounded-full'></div>
</div>
...
<div className='hidden lg:flex cursor-pointer transition-all duration-150 ease-in-out hover:scale-95  justify-center items-center'>
<span onClick={() => navigateToSection("section1")} className=' border-b-3 border-b-[#E692B3] font-extrabold text-[16px] text-[#E692B3]'>برگشت به عقب</span>
<svg width="9" height="14" viewBox="0 0 9 14" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8 1L2 7L8 13" stroke="#E692B3" stroke-width="2"/>
</svg>
...
<div className=' lg:hidden flex border-[1px] p-1.5 px-7 border-[#E692B3] rounded-[39px] cursor-pointer transition-all duration-150 ease-in-out hover:scale-95  justify-center items-center'>
<span onClick={() => navigateToSection("section1")} className='  font-extrabold text-[16px] text-[#E692B3]'>برگشت به عقب</span>
<svg width="9" height="14" viewBox="0 0 9 14" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8 1L2 7L8 13" stroke="#E692B3" stroke-width="2"/>
</svg>
...
<div ref={section1Ref} className='  gap-1 pb-3   flex flex-col justify-start lg:justify-center scrollbar-none  pt-10 lg:pt-0 overflow-y-scroll  max-h-[21rem]  h-[26rem]  lg:max-h-full  px-2 lg:px-12 lg:h-full  items-center lg:items-start'>
  ...
  <span className=' mb-3  bg-btn4 w-[110px]   hidden lg:block   text-center font-black text-[16.49px] py-1 rounded-[35.51px]'>20 % تخفیف</span>

<div className='w-[51px] h-[4px] lg:hidden block  mb-2 bg-[#F3BBD2] rounded-full'>.</div>
...
<span className='offcard1 hidden absolute -top-5 text-[13.03px] font-black  bg-btn4 text-center min-w-[48.35897816820379] rounded-[33.17px] rotate-[-25.15deg]   py-[4px]'>
20 %

</span>
</div>

<span className=' text-btn4 text-[14px] lg:text-[16px]  font-extrabold'>عنوان دسته بندی</span>
...
<path d="M76.7355 0.838163L0.60821 11.7034" stroke="#781BE1"/>
</svg>
...
<span className=' font-black text-btn4 text-[18px]'>180 هزارتومان</span>


<div className=' cursor-pointer  rounded-full p-2 px-6 border-[#E692B3] border-[1px]  transition-all duration-150 ease-in-out hover:scale-95 flex justify-center items-center'>
<span onClick={() => navigateToSection("section2")} className='  font-extrabold text-[16px] text-[#E692B3]'>مشاهده نظرات</span>
<svg width="9" height="14" viewBox="0 0 9 14" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8 1L2 7L8 13" stroke="#E692B3" stroke-width="2"/>
</svg>
...
<button onClick={() => navigateToSection("section3")} className=' cursor-pointer transition-all duration-150 ease-in-out hover:scale-95 flex justify-center w-[178px] py-3 bg-[#DA6D99] rounded-[11px] gap-2 items-center'>
...
<button className=' cursor-pointer transition-all duration-150 ease-in-out hover:scale-95 flex justify-center w-[178px] py-3 bg-btn4 rounded-[11px] gap-2 items-center'>
...
<button  className='  py-2 px-4 bg-[#781BE1]   rounded'>ثبت نظر</button>
</div>
