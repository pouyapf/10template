...
<ReactModal
      ...
      >
  <div className=' relative  bg-white   rounded-tr-[40px] rounded-tl-[40px]  lg:rounded-[40px]    h-[674px] w-screen lg:w-[800px]  '>
...
<path d="M24.7163 25.9665C24.3996 25.9665 24.0829 25.8499 23.8329 25.5999L14.3996 16.1665C13.9163 15.6832 13.9163 14.8832 14.3996 14.3999C14.8829 13.9165 15.6829 13.9165 16.1663 14.3999L25.5996 23.8332C26.0829 24.3165 26.0829 25.1165 25.5996 25.5999C25.3496 25.8499 25.0329 25.9665 24.7163 25.9665Z" fill="#8F9DAF"/>
    ...
    <div className='   relative     z-0  h-[674px]  w-screen  lg:w-[800px]   '>

   
    <div className=' lg:-right-66 top-23 left-1/2 -translate-x-1/2 lg:-bottom-0.5 absolute rounded-full
     flex justify-center items-center text-center  w-[336px] h-[336px] 
...
{activeSection==='section2' ?(    
    <div ref={section2Ref}  className='lg:w-[443px]  hcustom    w-full ml-0 mr-0 lg:mr-5  mt-20  lg:ml-6  h-[19rem]   flex flex-col  justify-start gap-1 items-start'>
...
<div ref={section1Ref} className='  gap-1 pb-3   flex flex-col justify-start lg:justify-center scrollbar-none  pt-10 lg:pt-0 overflow-y-scroll hcustom max-h-[21rem]  h-[26rem]  lg:max-h-full  px-2 lg:px-12 lg:h-full  items-center lg:items-start'>
...
</div>  ):(<div ref={section3Ref} className='lg:w-[361px] w-full  lg:mr-9  mr-0   px-2 lg:px-0  m-0 lg:ml-20  lg:min-h-[500px]  hcustom h-[19rem]    lg:h-[336px]  justify-start  flex flex-col lg:justify-center lg:gap-1 items-center lg:items-start'>
