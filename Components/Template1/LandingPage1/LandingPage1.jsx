...
function LandingPage1() {
  return (
    <div className='landingbg1 items-center flex justify-between overflow-hidden h-screen w-full relative'>
  ...
  <div className=' mr-56 relative  flex  justify-center flex-col items-center gap-4  z-10'>
 ...
 <button className='  text-[16px] w-[180px] font-extrabold   bg-btn1  px-0 rounded-[12px] p-2'>درباره فروشگاه</button>


<div className=' mt-3 w-[480px] bg-white flex justify-between px-4 items-center h-[72px] rounded-[12px]'>
...
<path d="M37 36.9996L32.3461 32.346M32.3461 32.346C34.3961 30.2952 35.664 27.4624 35.664 24.3333C35.664 18.0741 30.5905 13 24.332 13C18.0735 13 13 18.0741 13 24.3333C13 30.5925 18.0735 35.6667 24.332 35.6667C27.4619 35.6667 30.2953 34.3976 32.3461 32.346Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <div className=' z-30 w-[738px] flex flex-col  gap-14  justify-start items-center h-screen leftsidecont1 rounded-br-[64px]  rounded-tr-[64px]'>

<div className=' w-full mt-14     flex items-center justify-between px-10'>

<div className=' relative  w-fit'>
  <span  className='  relative text-[28px] font-black  z-10'>دسته بندی‌ها</span>
  <div className=' absolute  w-full  h-3  z-0       bottom-0 bg-textbg1'></div>


</div>
 
  <button className=' cursor-pointer text-[16px] font-extrabold px-3  bg-btn1  rounded-[12px] p-2'>مشاهده همه  آیتم‌ها</button>



</div>

<div className=' flex justify-center gap-4 items-center  px-10 flex-wrap flex-row-reverse'>
...
<CategoryItem link={'/'} text={'نوشیدنی‌های گرم و سرد'} icon={<DrinksIcon  color={"#900000"}/>} />
        ...
        <Image className=' absolute    z-0 right-0 top-0' src={'/assets/template1/1.png'} width={1000} height={1000} alt='Landing_Img'/>
        <Image className=' absolute    z-0  -right-5  -bottom-12' src={'/assets/template1/3.png'} width={1000} height={1000} alt='Landing_Img'/>
    </div>
  )
}
