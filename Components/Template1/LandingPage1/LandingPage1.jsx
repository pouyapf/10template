...
function LandingPage1() {
  ...
  return (
    <div ref={pageRef} className='landingbg1  landingbgmob1 items-center lg:flex-row flex-col  p-2 pt-5 lg:pt-0 lg:p-0  flex justify-between  min-h-screen overflow-hidden     w-full relative'>
