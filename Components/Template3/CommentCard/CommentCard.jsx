...
function CommentCard({isadmin}) {
  ...
  return (
    ...
    <div className={`lg:w-[443px] w-[95vw] relative  h-fit p-3.5    flex flex-col justify-between gap-3   ${isadmin ? 'bg-[#E0F2ED] mr-0 lg:mr-3 mt-2' :  'bg-white mt-5'} rounded-[20px] border-[1px]  border-[#A5E5D3]`}>


{isadmin ? (<div className=' absolute  w-1  -top-6  h-10 -z-10 bg-[#36B894]/50'></div>):(null)}
...
<g clip-path="url(#clip0_307_2883)">
<rect width="40" height="40" rx="13.3333" fill="#412820"/>
...
<rect width="40" height="40" rx="13.3333" fill="white"/>
  ...
  <g clip-path="url(#clip0_307_2851)">
  <rect width="40" height="40" rx="13.3333" fill="#36B894"/>
...
<div className=' flex flex-col justify-center items-start'>
    ...
    <span className='text-[12px]  text-[#6B483D] font-medium'>1403/10/27</span>
</div>
...
<path d="M8.36003 2.72614C9.0306 1.31346 10.9681 1.31346 11.6387 2.72613L12.7976 5.16761C13.0639 5.72858 13.5786 6.11741 14.174 6.20736L16.7655 6.59887C18.2649 6.8254 18.8636 8.74124 17.7786 9.84086L15.9034 11.7413C15.4726 12.1779 15.276 12.8071 15.3777 13.4236L15.8204 16.1071C16.0765 17.6598 14.509 18.8438 13.1679 18.1107L10.85 16.8438C10.3175 16.5527 9.68123 16.5527 9.14866 16.8438L6.83082 18.1107C5.48968 18.8438 3.9222 17.6598 4.17834 16.1071L4.62101 13.4236C4.72272 12.8071 4.52611 12.1779 4.09525 11.7413L2.22008 9.84086C1.13507 8.74125 1.73379 6.8254 3.23323 6.59887L5.82466 6.20736C6.42009 6.11741 6.93482 5.72858 7.20111 5.16761L8.36003 2.72614Z" fill="white" stroke="#9D796E" stroke-linejoin="round"/>
</svg>
        ...
        <path d="M8.36003 2.72614C9.0306 1.31346 10.9681 1.31346 11.6387 2.72613L12.7976 5.16761C13.0639 5.72858 13.5786 6.11741 14.174 6.20736L16.7655 6.59887C18.2649 6.8254 18.8636 8.74124 17.7786 9.84086L15.9034 11.7413C15.4726 12.1779 15.276 12.8071 15.3777 13.4236L15.8204 16.1071C16.0765 17.6598 14.509 18.8438 13.1679 18.1107L10.85 16.8438C10.3175 16.5527 9.68123 16.5527 9.14866 16.8438L6.83082 18.1107C5.48968 18.8438 3.9222 17.6598 4.17834 16.1071L4.62101 13.4236C4.72272 12.8071 4.52611 12.1779 4.09525 11.7413L2.22008 9.84086C1.13507 8.74125 1.73379 6.8254 3.23323 6.59887L5.82466 6.20736C6.42009 6.11741 6.93482 5.72858 7.20111 5.16761L8.36003 2.72614Z" fill="#36B894"/>
        </svg>
...
<div className=' flex justify-start gap-1 items-center'>     <span className='text-[#697C94] transition-all duration-150 ease-in-out hover:scale-95 hover:text-[#36B894]'><BiLike  size={20} /></span>
<span className=' text-[12px]  text-[#697C94] font-medium'>3</span></div>

<div className=' flex justify-start gap-1 items-center'>   <span className='text-[#697C94] transition-all duration-150 ease-in-out hover:scale-95 hover:text-[#36B894]'><BiDislike  size={20} /></span>
<span className=' text-[12px]  text-[#697C94] font-medium'>3</span></div>
