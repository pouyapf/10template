...
const Carousel = () => {
  ...
  return (
    <div className="relative  w-full lg:w-[454px] max-w-2xl mx-auto">
      ...
      {sliderInitialized && (
        <div className="absolute bg-btn1 rounded-[37.3px] p-2.5 px-7 -bottom-2 left-1/2 transform -translate-x-1/2 flex gap-2">
            ...
            (_, idx) => (
              <button
                ...
                className={`w-[12.86px] cursor-pointer h-[12.86px] rounded-full transition-all ${
                  currentSlide === idx ? "bg-textsec1 scale-125" : "bg-[#D9D9D9]"
                }`}
              ></button>
            )
          )}
